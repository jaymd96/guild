#!/bin/sh
# setup.sh — Set up the guild repository for development.
#
# Usage:
...
install_plugin() {
    info "Installing guild-skills plugin"

    PLUGIN_SRC="$REPO_ROOT/plugins/guild-skills"
    PLUGIN_DEST="$REPO_ROOT/.claude/plugins/guild-skills"
